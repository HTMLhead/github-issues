    ...
    <div id="issues-wrapper" class="m-auto  base-outer mt-6 bg-slate-100">
      <div class="issue-header h-16 flex justify-between items-center border-b">
        ...
        <div class="statusTab flex">
          <div class="whitespace-nowrap open-count font-bold cursor-pointer">${issueCount.open} Opens</div>
          <div class="whitespace-nowrap close-count ml-3 cursor-pointer">${issueCount.closed} Closed</div>
        </div>
...
export function getLabelTpl() {
  ...
  <form class="issue-label-form hidden p-3 mb-3 mt-6 border rounded-sm font-bold" id="new-label-form" action="/labels" accept-charset="UTF-8" method="post">
